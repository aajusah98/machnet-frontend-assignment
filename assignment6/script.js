const bounceSound = new Audio('music/bounce.mp3');
const breakSound = new Audio('music/break.mp3');
...
function drawBall() {
    ...
    ctx.fillStyle = ball.visible ? '#FFB319' : 'transparent';
    ctx.fill();
    ctx.closePath();
}
...
function drawPaddle() {
    ...
    ctx.fillStyle = paddle.visible ? '#911F27' : 'transparent';
    ctx.fill();
    ctx.closePath();
}
